...
3.[Rock_vs_Mine_binary_classification_with_feature_reduction.ipynb](https://github.com/anmancuso/SonarProject/blob/main/Rock_vs_Mine_binary_classification_without_feature_reduction.ipynb) -> ML with feature selection and data pre-processing ![This is the main script!](https://via.placeholder.com/15/f03c15/000000?text=+)(This is the main script!)
